...
cap replace infec=1 if v502==1 & v512>=5 & v512!=. & (tsinceb>59 | tsinceb==.) & v302a==0 & pregPPA24!=1 & substr(v000,3,1)=="6"
**Box 2
...
* DHS IV+ surveys
cap replace infec=1 if 	v3a08d==1 & (substr(v000,3,1)=="4" | substr(v000,3,1)=="5" | substr(v000,3,1)=="6")
* DHSIII surveys
